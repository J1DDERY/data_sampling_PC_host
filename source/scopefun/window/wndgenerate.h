...
#define GENERATOR_TYPE_ANALOG      0
#define GENERATOR_TYPE_DIGITAL     1
...
public:
    ...
    uint                     onOff1;
public:
    SGeneratorData           wndCustomAwg1;
    SGeneratorData           wndCustomAwg2;
    SGeneratorData           wndCustomDigital;
public:
    WndHardwareGenerator();
public:
    void loadCustomAwg(int idx, const char* path);
    void loadCustomDigital(const char* path);
    void uploadAwg(int idx);
    void uploadDigital();
public:
    void Default();
};
