...
#include <scopefun/gui/OsciloskopMeasure.h>
#include <scopefun/gui/OsciloskopInfo.h>
#include <scopefun/gui/OsciloskopDebug.h>
#include <scopefun/gui/OsciloskopStorage.h>
#include <scopefun/gui/OsciloskopConnection.h>
...
class OsciloskopOsciloskop : public Osciloskop
{
	protected:
		...
		void m_menuItemWriteCalibrateOnMenuSelection( wxCommandEvent& event );
		void m_menuItemReadCalibrateOnMenuSelection( wxCommandEvent& event );
		...
		void m_menuItemFactoryWriteEEPROMOnMenuSelection( wxCommandEvent& event );
		void m_menuItemEraseECalibrationOnMenuSelection( wxCommandEvent& event );
        void m_menuItemFactoryLoadFX3RamOnMenuSelection( wxCommandEvent& event );
		...
		void m_buttonResetOnButtonClick( wxCommandEvent& event );
		...
		void m_checkBoxDigitalPatternOutputEnableOnCheckBox( wxCommandEvent& event );
        void m_toggleBtnDigitalPatternOutputEnableOnToggle( wxCommandEvent& event );
		void m_buttonDigitalPatternRestartOnButtonClick( wxCommandEvent& event );
		void m_comboBoxDigitalPatternModeOnCombobox( wxCommandEvent& event );
		void m_checkBoxDigitalPatternRestartOnUploadOnCheckBox( wxCommandEvent& event );
