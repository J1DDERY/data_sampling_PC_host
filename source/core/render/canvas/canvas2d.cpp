...
int Canvas2dManager::start()
{
    ...
    normalShader->compile("canvas/canvas2D.fx", declPos2D, GrShaderDefine(nullptr));
    textureShader->compile("canvas/canvas2D.fx", declPosTex2D, GrShaderDefine("TEXTURE", nullptr));
