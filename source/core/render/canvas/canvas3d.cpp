...
int Canvas3dManager::start()
{
    ...
    shader3d[CANVAS3D_SHADER_DEFAULT]->compile("canvas/canvas3D.fx", declPos3D, GrShaderDefine(nullptr));
    shader3d[CANVAS3D_SHADER_DEFAULT_COLOR]->compile("canvas/canvas3D.fx", declPos3D, GrShaderDefine("COLOR", nullptr));
    shader3d[CANVAS3D_SHADER_NORMAL]->compile("canvas/canvas3D.fx", declPos3DNormal, GrShaderDefine("NORMAL", nullptr));
    shader3d[CANVAS3D_SHADER_NORMAL_COLOR]->compile("canvas/canvas3D.fx", declPos3DNormal, GrShaderDefine("NORMAL", "COLOR", nullptr));
    shader3d[CANVAS3D_SHADER_NORMAL_COLOR_LIGHT]->compile("canvas/canvas3D.fx", declPos3DNormal, GrShaderDefine("NORMAL", "COLOR", "LIGHT", nullptr));
    shader3d[CANVAS3D_SHADER_TEXTURE]->compile("canvas/canvas3D.fx", declPosUV3D, GrShaderDefine("TEXTURE", nullptr));
